...
/**
 * Class to represent a BattleList Data Transmission Object.
 * It has HATEOAS support using a list of links which would contain the next and previous links
 *
 * An instance of this class represents a DTO list of battles, for being translated into XML and being passed between client/server
