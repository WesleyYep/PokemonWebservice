...
create table Pokemon (id bigint generated by default as identity, gender varchar(255), level integer not null, name varchar(255), nickname varchar(255), TEAM_ID bigint, primary key (id))
...
alter table Pokemon add constraint FK_1wkbe2k7438hsnn9om6rdv8eu foreign key (TEAM_ID) references Team
