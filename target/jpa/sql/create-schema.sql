...
create table RECORD_BATTLES (Trainer_id bigint not null, battles_id bigint not null, primary key (Trainer_id, battles_id))
...
alter table RECORD_BATTLES add constraint UK_t06u30cupv51ch5ijb9i704bw  unique (battles_id)
...
alter table RECORD_BATTLES add constraint FK_t06u30cupv51ch5ijb9i704bw foreign key (battles_id) references Battle
alter table RECORD_BATTLES add constraint FK_jiq29atm0wrlqvo0inxiyj35 foreign key (Trainer_id) references Trainer
