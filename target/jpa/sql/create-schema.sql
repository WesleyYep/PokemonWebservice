...
create table Trainer (id bigint generated by default as identity, dateOfBirth date, firstName varchar(255), gender varchar(255), lastName varchar(255), badgesWon integer not null, battlesLost integer not null, battlesWon integer not null, competitionWins integer not null, primary key (id))
